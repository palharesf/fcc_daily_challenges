...
# Comments - straightforward to code, but requires some thinking. All AI suggestion went in the wrong direction
# The trick here is initializing the infection, then coding the doubling, and then the patch