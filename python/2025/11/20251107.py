...
def combinations(cards):
    deck = 52    
    return (factorial(deck) / (factorial(cards) * factorial(deck - cards)))
...
# Comments - it's more of a math challenge than a coding challenge. Setting up the factorial function can be a bit difficult, but it trivializes solving the problem