...
can_post("This message is too long to fit into either of the character limits for a social media post.")

# Comments - pretty easy challenge, not much to say here