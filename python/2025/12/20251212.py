...
# Comments - pretty straightforward problem. We loop through the shipment, checking if the item already exists in the inventory (in which case we add the quantity), or we add the item to the end of the inventory