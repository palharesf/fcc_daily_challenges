...
# Comments - sorting is always a bit of a chore, and here's no different.
# My attempts to sort it myself using for or while loops failed, and then AI gave me a solution in one-line.
# Learned a lot? I wouldn't say so